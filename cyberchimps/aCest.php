...
class aCest
{
    ...
    public function tryToTest(CyberchimpsTester $I)
    {
        ...
        $I->scrollTo('//*[@id="pricing-plans"]/div/div/div/div/div/div[2]/div/div/div[2]/div[1]/div/div/section/div/div/div[1]/div/div');
        ...
        $I->fillField('//*[@id="root"]/form/span[2]/span/input', '01 24');
        $I->switchtoIFrame();
        $I->wait(2);
        $I->switchtoIFrame('//*[@id="stripe-cvc-element"]/div/iframe');
        $I->fillField('//*[@id="root"]/form/span[2]/span/input', '121');
        $I->switchtoIFrame();
        $I->wait(2);
